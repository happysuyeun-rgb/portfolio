  ...
  (function(){
    ...
    const dict = {
      ko: {
        ...
        personal_card1_desc: '감정 기록 및 성장 루틴 관리 앱. 안드로이드 스토어 등록 완료',
        personal_mamssi_launch_badge: '출시 완료',
        ...
        mamssi_overview_chip6: 'Google Play 등록 완료',
        ...
        mamssi_role4_desc: 'Cursor AI 개발 협업, Vercel 배포, 사업소개서 작성, Google Play 스토어 등록 완료',
        ...
        mamssi_cta_sub: 'Google Play에 등록되었습니다. 아래에서 바로 앱을 만나보세요.',
        mamssi_store_cta: '🌱 앱 체험하기',
      ...
      en: {
        ...
        personal_card1_desc: 'Emotion journaling and growth routine app. Listed on Google Play.',
        personal_mamssi_launch_badge: 'Live',
        ...
        mamssi_hero_chip6: '● Live on Google Play',
        mamssi_overview_label: 'Overview',
        ...
        mamssi_overview_chip6: 'Live on Google Play',
        mamssi_role_label: 'My Role',
        ...
        mamssi_role4_desc: 'Collaborating with Cursor AI for development, deploying on Vercel, preparing pitch decks, and completing the Google Play store listing.',
        mamssi_persona_label: 'Persona',
        ...
        mamssi_cta_sub: 'Now on Google Play. Open the app from the button below.',
        mamssi_store_cta: '🌱 Try the app',
